...
Rectangle {
    ...
    Item {
        ...
        MouseArea {
            id: mouse1
            anchors.fill: parent
            onClicked: m_passengerFanControl.tempController--
        }
    ...
    Rectangle {
        ...
        PropertyAnimation {
            id: opacityAnimationForPassengersFan_T
            target: passengersFan_T
            property: "opacity"
            from: 0
            to: 1
            duration: 500
        ...
        Component.onCompleted: opacityAnimationForPassengersFan_T.start()
        ...
        Text {
            id: passengersFan_T
            text: m_passengerFanControl.tempController
            font.pixelSize: 25
            anchors.centerIn: parent
            color: fontcolor
            font {
